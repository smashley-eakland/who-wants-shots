...
<center> <h4> H1N1 Edition </h4> </center>
...
##### Target Variable - H1N1 Vaccine Status
 ...
 * opinion_seas_vacc_effective - Respondent's personal opinion about seasonal flu vaccine effectiveness (Omitted from H1N1 analysis)
     * Ranked from 1 (not at all effective) to 5 (very effective)
 * opinion_seas_risk - Respondent's personal opinion about risk of getting sick with seasonal flu without vaccine (Omitted from H1N1 analysis)
     * Ranked from 1 (very low) to 5 (very high)
 * opinion_seas_sick_from_vacc - Respondent's worry of getting sick from taking seasonal flu vaccine (Omitted from H1N1 analysis)
     * Ranked from 1 (not at all worried) to 5 (very worried).
 ...
 * seasonal_vaccine - Target Variable for seasonal flu predictive analysis (Omitted from H1N1 analysis)
